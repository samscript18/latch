...
export const wagmiConfig = createConfig({
  ...
  connectors: [
    injected(),
    ...(projectId
      ? [walletConnect({ projectId, showQrModal: true, metadata: { name: "LATCH", description: "Verifiable authority for autonomous AI workers", url: "https://latch-sec.vercel.app", icons: [] } })]
      : []),
  ],
});
