...
interface PurchasedProduct { productId?: string; name: string; vendor: string; productUrl?: string; quantity: number; unitPriceCents: number; totalAmountCents: number; currency: "USD"; source?: string }
interface ProcurementAction { actionType: "procurement.purchase"; item: string; quantity: number; amountCents: number; ensAuthorized: boolean; policyAuthorized: boolean; source?: string; executionReference?: string; results: PurchasedProduct[] }
